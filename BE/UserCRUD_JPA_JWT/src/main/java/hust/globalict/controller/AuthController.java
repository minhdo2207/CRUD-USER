...
import hust.globalict.config.JwtUtils;
import hust.globalict.dto.AuthenticationRequest;
import hust.globalict.dto.UserInput;
import hust.globalict.security.JpaUserDetailsService;
import hust.globalict.security.UserSecurity;
import hust.globalict.service.AuthService;
...
//                cookie.setSecure(true);
    ...
    public ResponseEntity<UserSecurity> register(@RequestBody UserInput user) throws Exception {
